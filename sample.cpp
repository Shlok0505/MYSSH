...
int main() {
  ...
  /*
Question 6: WAP to demonstrate how to create abstract class and implement the concept of run time
...
/*
Question 20: Create a Swing application that adds two numbers
*/
...
/*
Question 17: Write a Java program to display alternate characters from a given string.
*/
...
/*
Question 4: WAP to create a class called Circle. It contains:
...
/*
Question 14: WAP to demonstrate the File class constructors and any 4 methods of File class
*/
...
/*
Question 3: WAP to find sum and average of numbers from 1 to 10
*/
...
/*
Question 8: WAP to create an object of String class, store "HelloWorld"and perform following
operations:
...
/*
Question 9: WAP to create an object of StringBuilder class and perform following operations:
i. append
ii. insert
iii. replace
iv. delete
...
/*
Question 5: WAP to create a class called Square. It contains:
...
/*
Question 18: Create a Swing application that calculates a square of a number.
*/
...
/*
Question 12: WAP to implement the following methods of LinkedList:
...
/*
Question 7: WAP to demonstrate the sequence of execution of constructors in multilevel inheritance.
*/
...
/*
Question 15: WAP to demonstrate how to write a text file using FileOutputStream.
*/
...
/*
Question 13: WAP to demonstrate how to read a text file using FileReader.
*/
...
/*
Question 2: WAP to find greatest among three numbers using if-else.
*/
